...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(orderBook.getBestAsk().getKey() +"best ask");
        System.out.println(orderBook.getBestBid().getKey()+"best bid");
        orderBook.printBook();
        System.out.println(orderBook.getBidAskSpread());
